...
<html lang="fr">
    <head>
      ...
      <base href="http://www.borin.fr/Projets/BSPA/">
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container">
          <a class="navbar-brand" href="Homepage">Billet simple pour l'Alaska</a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="inscription">login</a>
              </li>
          ...
          <!-- Page Header -->
      <header class=" test masthead" style="background-image: url('img/home-bg.jpg')">
      ...
      <footer>
        <div class="container">
          <div class="footer">
            <?php if (!empty($_SESSION)) { ?>
                <p>Vous êtes connecté avec <?= $_SESSION['username'] ?> vous pouvez vous déconnecter <a href="logOut"><em> ici </em></a></p>
            <?php } ?>
          </div>
        </div>
      </footer>
