                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content modalContent">
                              ...
                              <div class="modal-footer">
                                ...
                                <button class="boutonCheck btn-danger "><a href="index.php?action=valideComment&amp;id=<?= $comment['id']?>&amp;postId=<?= $post['id']?>">Non, je voulais cliquer</br> sur valider</a></button>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content modalContent">
                              ...
                              <div class="modal-footer">
                                ...
                                <button class="boutonCheck btn-success "><a href="index.php?action=valideComment&amp;id=<?= $comment['id']?>&amp;postId=<?= $post['id']?>">Oui, je veux le valider</a></button>
...
<?php if (empty($_SESSION)){?>
    <?php ob_start(); ?>
        ...
        <?php } ?>
         <p>Pour poster des commentaires ou signaler un contenu <a href="index.php?action=inscription&amp;">connectez vous ici</a> </p>
        <?php $posts->closeCursor(); ?>
    <?php $content = ob_get_clean(); ?>
